...
define(['jquery', 'core'], function($, core) {
    ...
    var core = {
        ...
        default_options: {
            baseUrl: '',
            siteUrl: '',
            staticUrl: '../addons/ewei_shopv2/static/jiyin/'
        },
        options: {},
    };
      ...
      core.loading =  function() {
          var u = navigator.userAgent, app = navigator.appVersion;
           if ($('#core_loading').length <= 0) {
                $('body').append('<div id="core_loading" style="top:50%;left:50%;margin-left:-5%;/*margin-top:-30px;*/position:absolute;width:50px;z-index:999999"><img src="../addons/ewei_shopv2/static/images/loading.gif" width="30" height="30" /></div>')
            }
            else{
                $('#core_loading').show();
            }
