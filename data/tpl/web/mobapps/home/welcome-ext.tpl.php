...
<div class="shortcut clearfix">
	...
	<a class="item"  data-type=<?php  echo $row['type'];?> href="<?php  if($row['type'] != 'system') { ?>./index.php?c=home&a=welcome&do=ext<?php  } else { ?>./index.php?c=platform&a=reply<?php  } ?>&m=<?php  echo $row['name'];?>">
