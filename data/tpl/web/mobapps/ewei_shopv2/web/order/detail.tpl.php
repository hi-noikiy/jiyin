                ...
                <div class="form-group" style='padding:0 10px;'>
                    <table class='ordertable' style='table-layout:fixed'>
                        ...
                        <tr>
                            ...
                            <td>
                            	<?php  if($item['code']!='') { ?>
                            		已使用(最大优惠<?php  echo $item['codeprice'];?>)
                            	<?php  } else { ?>
                            		未使用
                            	<?php  } ?>
                            </td>
                         ...
                         <tr>
                            <td>分销优惠：</td>
                            <td>
                            	<?php  if($item['favourable']==1) { ?>
                            		已优惠(<?php  echo $item['favourablemoney'];?>)元
                            	<?php  } else { ?>
                            		未优惠
                            	<?php  } ?>
                            </td>
...
"><i class='fa fa-question-circle'></i></a></td>
                    ...
                    <table class='ordertable' style='table-layout:fixed;border-top:1px dotted #ccc'>
                        ...
                        <tr>
                            ...
                            <td>
								<?php  $disaddress=pdo_get('ewei_shop_dispatch', array('id' =>$item['disid']), array('dispatchname', 'id','price'));?>
								<?php  echo $disaddress['dispatchname'];?>(包含邮费<?php  echo $disaddress['price'];?>元)
                            </td>
                        </tr>
                ...
                <tr>
                    ...
                    <td  style='border:none;text-align:right;'><?php  echo date('Y-m-d H:i',$v['verifytime'])?></td>
                        ...
                        <tr>
                            ...
                            <td style='word-break: break-all;white-space: normal'>
                                ...
                                <tr>
                                    ...
                                    <td style='word-break: break-all;white-space: normal'><?php  echo $item['realmobile'];?></td>
                                </tr>
 

                            <tr>
                                <td style='width:80px'>联系地址：</td>
                                <td style='word-break: break-all;white-space: normal'><?php  echo $item['realaddress'];?></td>
                            </tr>
                            <tr>
                                <td style='width:80px'>区域代码：</td>
                                <td style='word-break: break-all;white-space: normal'><?php  echo $item['areacode'];?></td>
                            </tr>
                        <?php  } else { ?>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td style='display:none;word-break: break-all;white-space: normal'><?php  if($item['merchid'] == 0) { ?><a class="btn btn-primary btn-xs" data-toggle="ajaxModal" href="<?php  echo webUrl('order/op/changeaddress', array('id' => $item['id']))?>">编辑收货信息</a><?php  } ?></td>
                        </tr>
                        <?php  } ?>
                        <?php  } ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <p class="form-control-static ops">
                            ...
                            <a style="display: none;" class='op'  data-toggle='ajaxModal' href="<?php  echo webUrl('order/op/changeprice',array('id'=>$item['id']))?>">订单改价</a>&nbsp;&nbsp;
                            <?php  } ?>
                            <?php  } ?>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    <td class='full'>
                        ...
                        <br/>
                        <?php  if($item['fpstatus']==0 ) { ?>
                        	<label class='label label-danger'>不要发票</label>
                        <?php  } else { ?>
                        	<label class='label label-danger'>需要开票</label>
                        	<?php  if($item['receipttype']==1 ) { ?>
                        	<label class='label label-danger'>个人发票</label>
                        	<?php  } else { ?>
                         	<label class='label label-danger'>企业发票</label>  
                          	<label class='label label-danger'>企业名称:<?php  echo $item['receiptname'];?></label>   
                         	<label class='label label-danger'>纳税人识别码:<?php  echo $item['receiptcode'];?></label>                           	
                         	<?php  } ?>
                        <?php  } ?>
