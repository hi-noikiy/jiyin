    ...
    <div class="tabs-container tab-goods">
        <div class="tabs-left">
            <ul class="nav nav-tabs" id="myTab">
                ...
                <li <?php  if($_GPC['tab']=='buy') { ?>class="active"<?php  } ?> style="display:none;" ><a href="#tab_buy">购买权限</a></li>
                <li <?php  if($_GPC['tab']=='sale') { ?>class="active"<?php  } ?> style="display:none;" ><a href="#tab_sale">营销</a></li>
                <li <?php  if($_GPC['tab']=='discount') { ?>class="active"<?php  } ?>  style="display:none;"><a href="#tab_discount">会员折扣</a></li>
                ...
                <?php  if($merchid == 0) { ?>
                <li <?php  if($_GPC['tab']=='verify') { ?>class="active"<?php  } ?> style="display:none;"><a href="#tab_verify" >线下核销</a></li>
                <?php  } ?>
