...
<div class="form-group">
    ...
    <div class="col-sm-11">
        ...
        <input type="text" name="total" id="total" class="form-control hasoption" data-rule-required="true" value="<?php  echo $item['total'];?>"  style="width:150px;display: inline;margin-right: 20px;" <?php  if($item['hasoption']) { ?>readonly<?php  } ?>/>
...
<div class="form-group" style="display: none;">
	...
	<label class="checkbox-inline">
	  ...
	  <span class="help-block" style="display: none;">启用商品规格后，商品的价格及库存以商品规格为准,库存设置为0则会到”已售罄“中，手机也不会显示, -1为不限制</span>
