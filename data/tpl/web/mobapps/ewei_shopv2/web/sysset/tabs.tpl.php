...
<div class='menu-header'>API接口密钥</div>
<ul>
    <li><a href="<?php  echo webUrl('sysset/apia')?>">商城验证API配置</a></li>
    <li><a href="<?php  echo webUrl('sysset/apib')?>">商城请求API配置</a></li>
</ul>
<?php  } ?>
...
<div class='menu-header'>第三方应用调用</div>
<ul>
    <li class="active" <?php  if($_W['routes']=='sysset.sms.set') { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('sysset/createlink/index')?>">生成链接</a></li>
</ul>
...
<div class='menu-header'>退款设置</div>
<li <?php  if($_W['routes']=='sysset.printer.printer_list') { ?>class="active"<?php  } ?>><a href="<?php  echo webUrl('sysset/refund')?>">退款自定义设置</a></li>
<?php  } ?>
<?php  } ?>
